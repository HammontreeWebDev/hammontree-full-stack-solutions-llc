...
function Socials(props) {
    return (
        <>
            <Head>
                <title> Socials | Hammontree Full-Stack Solutions LLC</title>
                <meta name="description" content="Follow Kaileb Hammontree and Hammontree Full-Stack Solutions on FaceBook, GitHub, and LinkedIn." />
