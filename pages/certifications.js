    ...
    return (
        <>
            ...
            <main className="portfolio-body">
                ...
                <CertificateCard src={"/img/coding-cert.webp"} verification={'https://badgr.com/public/assertions/ewkha2NyQ8-IAo-788fTUA'} alt={'UCF Full-Stack Coding Boot Camp Certificate'} appTitle={'UCF Coding Boot Camp'} photo_icon={'img/bootcamp-bg.webp'}/>
                ...
                <CertificateCard src={"/img/cyber-cert.webp"} verification={'https://badgr.com/public/assertions/Rxyg7wKwTgWLC07_shNy6A'} alt={'UCF Cyber Defense Professional Certificate'} appTitle={'UCF Cyber Defense Professional Certificate'} photo_icon={'img/cyber-bg.webp'}/>
                ...
                <CertificateCard src={"/img/css-cert.webp"} verification={'https://www.hackerrank.com/certificates/c7a702eeeac3'} alt={'Hacker Rank CSS Skill Verification'} appTitle={'CSS Skill Certification'} photo_icon={'img/css-bg.webp'}/>
                ...
                <CertificateCard src={"/img/front-end-cert.webp"} verification={'https://www.hackerrank.com/certificates/4d0e4bd62b7c'} alt={'Hacker Rank Front End Developer for React Role Verification'} appTitle={'Frontend Developer (React) Certification'} photo_icon={'img/react-bg.webp'}/>
