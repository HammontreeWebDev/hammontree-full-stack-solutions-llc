  ...
  return (
    <>
      ...
      <main className='portfolio-body'>
        ...
        <Project src={"/img/jboo-mockup.webp"} deployment={'https://www.j-boocustoms.org/'} repository={'https://github.com/HammontreeWebDev/j-boo-customs-nextJS'} alt={'screenshot of J-Boo Customs Website'} appTitle={'Jesse Ryder Brown Foundation, Inc'} content={'ReactJS | NextJS | Node.js | Custom CSS'} photo_icon={'img/motocross.webp'} lowResPhoto={'img/motocross-low-res.webp'} />
        ...
        <Project src={"/img/Brofit.webp"} deployment={'https://www.reesewilder.com/'} click={privateAlert} alt={'screenshot of BroFit Personal Training website'} appTitle={'BroFit Personal Training'} content={'HTML | BootStrap | CSS | JavaScript'} photo_icon={'img/gym.webp'} lowResPhoto={'img/gym-low-res.webp'}/>

        {/* gym.webp Photo by Leon Ardho: https://www.pexels.com/photo/barbell-on-the-floor-1552252/ */}

        {/* Outta-Touch */}
        <Project src={"/img/OuttaTouch.webp"} deployment={'https://outta-touch.herokuapp.com/'} repository={'https://github.com/argounova/outta-touch'} alt={'screenshot of outta touch application'} appTitle={'OUTTA TOUCH'} content={'MERN stack | Apollo | Websocket/GraphQL subscriptions'} photo_icon={'img/lonely.webp'} lowResPhoto={'img/lonely-low-res.webp'}/>

        {/* lonely.webp Photo by mikoto.raw Photographer : https://www.pexels.com/photo/photo-of-woman-using-mobile-phone-3367850/ */}


        {/* MTG ++ App */}
        <Project src={"/img/MTGpp.webp"} deployment={'https://peaceful-escarpment-11973.herokuapp.com/'} repository={'https://github.com/HammontreeWebDev/MTGpp'} alt={'screenshot of MGT++ deck building application'} appTitle={'MTG++'} content={'Node.js | Express.js | MySQL | JavaScript | jQuery | Handlebars | Bootstrap | CSS'} photo_icon={'img/falling.webp'} lowResPhoto={'img/falling-low-res.webp'}/>
        ...
        {/* PokéWire App */}
        <Project src={"/img/pokewire.webp"} deployment={'https://luckysal.github.io/pokewire/index.html'} repository={'https://github.com/LuckySal/pokewire'} alt={'screenshot of PokéWire application'} appTitle={'PokéWire'} content={'HTML5 | JavaScript | jQuery | Bulma | CSS | API'} photo_icon={'img/child.webp'} lowResPhoto={'img/child-low-res.webp'}/>
